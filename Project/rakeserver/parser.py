...
class Parser:
  def __init__(self, path="", verbose=False):
    print("[parser] Initialising Parser object.")
    ...
    if self.actionsets and self.hosts :
      ...
      for actionNum, commands in enumerate(self.actionsets):
        ...
        for command in commands:
          print(">>", command)
        print('')
      print("[parser] Completed result printing.\n")
    else:
      print("[parser] No Rakefile parsed.")
  ...
  def readRakefile(self):
    ...
    print("[parser] Reading Rakefile at '" + self.path + "'...")
    try:
